...
class DeleteMovieUseCase @Inject constructor(private val movieRepositories: MovieRepositories) {
    suspend operator fun invoke(movie: MovieEntity) = movieRepositories.deleteMovie(movie)
}