...
class GetFavouriteMovieUseCase @Inject constructor(private val movieRepositories: MovieRepositories) {
    operator fun invoke() = movieRepositories.getFavouriteMovieData()
}