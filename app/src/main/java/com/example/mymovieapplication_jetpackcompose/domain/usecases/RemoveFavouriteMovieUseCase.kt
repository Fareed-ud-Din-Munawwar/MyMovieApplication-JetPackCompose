...
class RemoveFavouriteMovieUseCase @Inject constructor(private val movieRepositories: MovieRepositories) {
    suspend operator fun invoke(movie: MovieEntity) = movieRepositories.removeFavouriteMovie(movie)
}