...
class AddFavouriteMovieUseCase @Inject constructor(private val movieRepositories: MovieRepositories) {
    suspend operator fun invoke(movie: MovieEntity) = movieRepositories.addFavouriteMovie(movie)
}